      ...
      <div className={styles.main}>
        ...
        <div>
          ...
          <div>
            <div></div>
            <div>Github</div>
            <Link href={"https://github.com/Yuan12131"}>이동하기</Link>
          </div>
          ...
          <div>
            <div>
                <div></div>
              <div>Notion</div>
            <Link href={"https://ubiquitous-ravioli-eff.notion.site/ba88aea188ab4d718edb14f9e8138fd7?v=e841ca3e13d7404fbe02cc84a5cdb922"}>이동하기</Link>
